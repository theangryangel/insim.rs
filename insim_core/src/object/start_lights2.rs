...
impl ObjectVariant for StartLights2 {
...
mod tests {
    ...
    #[test]
    fn test_start_lights2_round_trip() {
        let original = StartLights2::default();
        let wire = original.to_wire().expect("to_wire failed");
        let decoded = StartLights2::from_wire(wire).expect("from_wire failed");
