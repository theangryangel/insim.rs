...
impl ObjectInfo {
    ...
    pub fn heading_mut(&mut self) -> Option<&mut Heading> {
        match self {
            ObjectInfo::Control(o) => Some(&mut o.heading),
            ObjectInfo::Marshal(o) => Some(&mut o.heading),
            ObjectInfo::InsimCheckpoint(o) => Some(&mut o.heading),
            ObjectInfo::ChalkLine(o) => Some(&mut o.heading),
            ObjectInfo::ChalkLine2(o) => Some(&mut o.heading),
            ObjectInfo::ChalkAhead(o) => Some(&mut o.heading),
            ObjectInfo::ChalkAhead2(o) => Some(&mut o.heading),
            ObjectInfo::ChalkLeft(o) => Some(&mut o.heading),
            ObjectInfo::ChalkLeft2(o) => Some(&mut o.heading),
            ObjectInfo::ChalkLeft3(o) => Some(&mut o.heading),
            ObjectInfo::ChalkRight(o) => Some(&mut o.heading),
            ObjectInfo::ChalkRight2(o) => Some(&mut o.heading),
            ObjectInfo::ChalkRight3(o) => Some(&mut o.heading),
            ObjectInfo::PaintLetters(o) => Some(&mut o.heading),
            ObjectInfo::PaintArrows(o) => Some(&mut o.heading),
            ObjectInfo::Cone1(o) => Some(&mut o.heading),
            ObjectInfo::Cone2(o) => Some(&mut o.heading),
            ObjectInfo::ConeTall1(o) => Some(&mut o.heading),
            ObjectInfo::ConeTall2(o) => Some(&mut o.heading),
            ObjectInfo::ConePointer(o) => Some(&mut o.heading),
            ObjectInfo::TyreSingle(o) => Some(&mut o.heading),
            ObjectInfo::TyreStack2(o) => Some(&mut o.heading),
            ObjectInfo::TyreStack3(o) => Some(&mut o.heading),
            ObjectInfo::TyreStack4(o) => Some(&mut o.heading),
            ObjectInfo::TyreSingleBig(o) => Some(&mut o.heading),
            ObjectInfo::TyreStack2Big(o) => Some(&mut o.heading),
            ObjectInfo::TyreStack3Big(o) => Some(&mut o.heading),
            ObjectInfo::TyreStack4Big(o) => Some(&mut o.heading),
            ObjectInfo::MarkerCorner(o) => Some(&mut o.heading),
            ObjectInfo::MarkerDistance(o) => Some(&mut o.heading),
            ObjectInfo::LetterboardWY(o) => Some(&mut o.heading),
            ObjectInfo::LetterboardRB(o) => Some(&mut o.heading),
            ObjectInfo::Armco1(o) => Some(&mut o.heading),
            ObjectInfo::Armco3(o) => Some(&mut o.heading),
            ObjectInfo::Armco5(o) => Some(&mut o.heading),
            ObjectInfo::BarrierLong(o) => Some(&mut o.heading),
            ObjectInfo::BarrierRed(o) => Some(&mut o.heading),
            ObjectInfo::BarrierWhite(o) => Some(&mut o.heading),
            ObjectInfo::Banner(o) => Some(&mut o.heading),
            ObjectInfo::Ramp1(o) => Some(&mut o.heading),
            ObjectInfo::Ramp2(o) => Some(&mut o.heading),
            ObjectInfo::VehicleSUV(o) => Some(&mut o.heading),
            ObjectInfo::VehicleVan(o) => Some(&mut o.heading),
            ObjectInfo::VehicleTruck(o) => Some(&mut o.heading),
            ObjectInfo::VehicleAmbulance(o) => Some(&mut o.heading),
            ObjectInfo::SpeedHump10M(o) => Some(&mut o.heading),
            ObjectInfo::SpeedHump6M(o) => Some(&mut o.heading),
            ObjectInfo::SpeedHump2M(o) => Some(&mut o.heading),
            ObjectInfo::SpeedHump1M(o) => Some(&mut o.heading),
            ObjectInfo::Kerb(o) => Some(&mut o.heading),
            ObjectInfo::Post(o) => Some(&mut o.heading),
            ObjectInfo::Marquee(o) => Some(&mut o.heading),
            ObjectInfo::Bale(o) => Some(&mut o.heading),
            ObjectInfo::Bin1(o) => Some(&mut o.heading),
            ObjectInfo::Bin2(o) => Some(&mut o.heading),
            ObjectInfo::Railing1(o) => Some(&mut o.heading),
            ObjectInfo::Railing2(o) => Some(&mut o.heading),
            ObjectInfo::StartLights1(o) => Some(&mut o.heading),
            ObjectInfo::StartLights2(o) => Some(&mut o.heading),
            ObjectInfo::StartLights3(o) => Some(&mut o.heading),
            ObjectInfo::SignMetal(o) => Some(&mut o.heading),
            ObjectInfo::SignSpeed(o) => Some(&mut o.heading),
            ObjectInfo::ConcreteSlab(o) => Some(&mut o.heading),
            ObjectInfo::ConcreteRamp(o) => Some(&mut o.heading),
            ObjectInfo::ConcreteWall(o) => Some(&mut o.heading),
            ObjectInfo::ConcretePillar(o) => Some(&mut o.heading),
            ObjectInfo::ConcreteSlabWall(o) => Some(&mut o.heading),
            ObjectInfo::ConcreteRampWall(o) => Some(&mut o.heading),
            ObjectInfo::ConcreteShortSlabWall(o) => Some(&mut o.heading),
            ObjectInfo::ConcreteWedge(o) => Some(&mut o.heading),
            ObjectInfo::StartPosition(o) => Some(&mut o.heading),
            ObjectInfo::PitStartPoint(o) => Some(&mut o.heading),
            ObjectInfo::PitStopBox(o) => Some(&mut o.heading),
            ObjectInfo::ChevronLeft(o) => Some(&mut o.heading),
