...
impl ObjectVariant for ChalkLine2 {
...
mod tests {
    ...
    #[test]
    fn test_chalk_line2_round_trip() {
        let original = ChalkLine2::default();
        let wire = original.to_wire().expect("to_wire failed");
        let decoded = ChalkLine2::from_wire(wire).expect("from_wire failed");
