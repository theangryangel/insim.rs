...
## [4.0.0](https://github.com/theangryangel/insim.rs/compare/insim_pth-v3.1.0...insim_pth-v4.0.0) - 2026-07-19
...
- *(pth2svg)* fix up pth2svg to match the in-game display by flipping the y axis and execute linting
- *(pth)* refactor track limit computation

### Other

- after moving to prek, we now test *all* crates, not just the default ones
