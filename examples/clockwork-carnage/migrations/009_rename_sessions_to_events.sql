...
ALTER TABLE climb_sessions     RENAME TO climb_events;
...
ALTER TABLE climb_events       RENAME COLUMN session_id TO event_id;
...
ALTER TABLE climb_times        RENAME COLUMN session_id TO event_id;
